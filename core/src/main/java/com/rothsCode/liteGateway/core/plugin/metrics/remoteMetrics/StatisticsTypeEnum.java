...
public enum StatisticsTypeEnum {
  ...
  API_TIME("count", "apiTime", "接口响应百分比分布时间"),
  API_TOTAL_TIME("count", "apiTotalTime", "接口总响应时间"),
  API_AVG_TIME("count", "apiAvgTime", "接口平均响应时间"),
  PRE_GATEWAY_TIME("count", "preGatewayTime", "网关前置处理百分比分布时间"),
  POST_GATEWAY_TIME("count", "postGatewayTime", "网关后置处理百分比分布时间"),
