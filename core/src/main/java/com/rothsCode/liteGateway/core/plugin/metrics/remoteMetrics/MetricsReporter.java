...
public class MetricsReporter {
  ...
  public static void register(final MetricsRegister metricsRegister) {
    ...
    MetricsReporter.registerCounter(StatisticsTypeEnum.SUCCESS.getCode(),
        StatisticsTypeEnum.SUCCESS.getDesc());
    MetricsReporter
        .registerCounter(StatisticsTypeEnum.ERROR.getCode(), StatisticsTypeEnum.ERROR.getDesc());
    MetricsReporter.registerCounter(StatisticsTypeEnum.TIMEOUT.getCode(),
        StatisticsTypeEnum.TIMEOUT.getDesc());
    MetricsReporter.registerCounter(StatisticsTypeEnum.MAX_TIME.getCode(),
  ...
  public static void registerMetrics(final Collection<Metric> metrics) {
    for (Metric metric : metrics) {
      switch (metric.getType()) {
        case COUNTER:
          registerCounter(metric.getName(), getLabelNames(metric.getLabels()),
              metric.getDocument());
          break;
        case GAUGE:
          ...
          break;
        case HISTOGRAM:
          registerHistogram(metric.getName(), getLabelNames(metric.getLabels()),
              metric.getDocument());
          break;
        default:
   ...
   */
  public static void registerCounter(final String name, final String[] labelNames,
   ...
   */
  public static void registerGauge(final String name, final String[] labelNames,
      final String document) {
    Optional.ofNullable(metricsRegister)
        .ifPresent(register -> register.registerGauge(name, labelNames, document));
  }
   ...
   */
  public static void registerHistogram(final String name, final String[] labelNames,
      final String document) {
    Optional.ofNullable(metricsRegister)
  ...
  public static void counterIncrement(final String name, final String[] labelValues,
      final long count) {
    Optional.ofNullable(metricsRegister)
        .ifPresent(register -> register.counterIncrement(name, labelValues, count));
  }
  ...
  public static void gaugeIncrement(final String name, final String[] labelValues) {
    Optional.ofNullable(metricsRegister)
        .ifPresent(register -> register.gaugeIncrement(name, labelValues));
  }
  ...
  public static void gaugeDecrement(final String name, final String[] labelValues) {
    Optional.ofNullable(metricsRegister)
        .ifPresent(register -> register.gaugeDecrement(name, labelValues));
  }
   ...
   */
  public static void recordTime(final String name, final String[] labelValues,
      final long duration) {
    Optional
        .ofNullable(metricsRegister)
        .ifPresent(register -> register.recordTime(name, labelValues, duration));
  }
